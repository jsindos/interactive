...
export default () =>
  <div id='main'>
    ...
    {/* <div id='mission' className='row indent'>
      <h2>Mission</h2>
      ...
      <div className='accordions row_w jc-sb'>
        <input type='checkbox' className='display-none' id='defining_cyber' name='defining_cyber' checked='' />
        <label for='defining_cyber' style='margin-bottom: 377px;'><span>Defining Cyber</span></label>
        <div className='content defining_cyber'>
          <div>
        ...
        <input type='checkbox' className='display-none' id='problem_cyber' name='problem_cyber' />
        <label for='problem_cyber' style='margin-bottom: 352px;'><span>The Problem with Cyber</span></label>
        <div className='content problem_cyber'>
          <div>
    ...
    <div id='key_functions' className='row indent'>
      <h2>Key Functions</h2>
      <div className='accordions row_w jc-sb'>
        <input type='checkbox' className='display-none' id='cyber_hub' name='cyber_hub' checked='' />
        <input type='checkbox' className='display-none' id='education' name='education' />
        <input type='checkbox' className='display-none' id='wicked_problems' name='wicked_problems' />

        <label for='cyber_hub' style='margin-bottom: 563px;'><span>The Cyber Hub</span></label>
        <div className='content cyber_hub'>
          <div>
        ...
        <div className='content wicked_problems'>
          <div>
    ...
    <div id='advisory_board' className='row indent team'>
      <h2>Advisory Board</h2>
      <div id='team' className='row_w'>
        <div className='member'>
          <div className='img' style="background-image: url('/img/professor_brian_schmidt.jpg')" />
          <div className='hover'>
            <div>
        ...
        <div className='member'>
          <div className='img' style="background-image: url('/img/professor_elanor_huntington.jpg')" />
          <div className='hover'>
            <div>
        ...
        <div className='member'>
          <div className='img' style="background-image: url('/img/professor_rory_medcalf.jpg')" />
          <div className='hover'>
            <div>
        ...
        <div className='member'>
          <div className='img' style="background-image: url('/img/marie_johnson.jpg')" />
          <div className='hover'>
            <div>
        ...
        <div className='member'>
          <div className='img' style="background-image: url('/img/hamish_hawthorn.jpg')" />
          <div className='hover'>
            <div>
        ...
        <div className='member'>
          <div className='img' style="background-image: url('/img/deborah_anton.jpg')" />
          <div className='hover'>
            <div>
        ...
        <div className='member'>
          <div className='img' style="background-image: url('/img/mick_ryan.jpg')" />
          <div className='hover'>
            <div>
    ...
    <div id='strategic_partnering' className='row indent'>
      ...
      <div className='two-col row_w jc-sb'>
        <div>
